        ...
        <div className="bg-white mb-12">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="w-full md:w-1/3">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 border-b border-gray-300 focus:outline-none focus:border-black transition-colors font-pretendard"
                />
                <svg
            ...
            <div className="flex items-center space-x-6">
              <select 
                className="border-none bg-transparent focus:ring-0 text-sm font-pretendard"
                value={sortOption}
              ...
              <label className="inline-flex items-center text-sm">
                ...
                />
                <span className="ml-2 font-pretendard">품절 상품 표시</span>
              </label>
            </div>
          </div>
        </div>
