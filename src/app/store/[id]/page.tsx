            ...
            >
              <>
                <div className={`grid ${getProductSpacing()}`}
                    ...
                    <Link
                      href={`/store/${store.id}/product/create`}
                      className="group aspect-square flex flex-col items-center justify-center p-6 text-gray-500 hover:text-gray-600 transition-colors bg-gray-50 hover:bg-gray-100"
                    >
